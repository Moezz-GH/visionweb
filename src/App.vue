          ...
          <ul class="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
            ...
            <li>
              <router-link
                ...
                class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-maincolor md:p-0 md:dark:hover:text-blue-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700"
                exact-active-class="text-secondarycolor"
                active-class="text-secondarycolor">مقالات</router-link>
            </li>
            <!-- Dropdown menu -->
             <li class="relative" ref="dropdownRef">
              <button @click="toggleDropdown"
                class="flex items-center justify-between w-full py-2 px-3 text-gray-900 rounded-md hover:bg-gray-100 md:hover:bg-transparent md:hover:text-secondarycolor md:p-0 md:w-auto">
                خدماتنا
                <svg class="w-2.5 h-2.5 mr-2 transition-transform transform" :class="{'rotate-180': isDropdownOpen}"
              ...
              <div v-show="isDropdownOpen"
                class="absolute left-0 mt-2 w-44 rounded-lg shadow-lg bg-white border border-gray-100">
                <ul class="py-2 text-sm text-gray-700">
                  <li><router-link to="/MoneyTransfers" @click="closeDropdown" class="block px-4 py-2 hover:bg-gray-100">الحولات المالية</router-link></li>
                  <li><router-link to="/Services" @click="closeDropdown" class="block px-4 py-2 hover:bg-gray-100">تداول معنا</router-link></li>
                  <li><router-link to="/tadawelforfox" @click="closeDropdown" class="block px-4 py-2 hover:bg-gray-100">التداول الالي للفوركس</router-link></li>
                  <li><router-link to="/EducationalCourses" @click="closeDropdown" class="block px-4 py-2 hover:bg-gray-100">الدورات التدريبية</router-link></li>
                </ul>
              </div>
            </li>
            <li>
              <router-link
                ...
                class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-maincolor md:p-0 md:dark:hover:text-blue-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700"
                exact-active-class="text-secondarycolor"
                active-class="text-secondarycolor">من نحن</router-link>
            </li>
          </ul>
        </div>
      </div>
  ...
  <div class="mx-auto max-w-screen-xl px-4 pt-16 pb-8 sm:px-6 lg:px-8">
    ...
    <div class="mt-6">
      <ul class="flex justify-center gap-6 sm:justify-center mb-4">
        <li>
          <a
            href="https://t.me/visionfortrading"
            rel="noreferrer"
            target="_blank"
        ...
        <li>
          <a
            href="https://www.youtube.com/@Visionfortrading"
            rel="noreferrer"
            target="_blank"
            class="text-secondarycolor transition hover:text-secondarycolor/2"
          >
