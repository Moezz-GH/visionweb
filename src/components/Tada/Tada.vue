...
<div class="bg-secondarycolor h-[32rem] bg-center bg-cover bg-no-repeat pt-24">
    <div class="animate__animated animate__backInDown py-18 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
               <p class="my-4 text-5xl font-serif text-white mt-10 dark:text-gray-400 mb-9"> التداول الالي للفوركس</p>
        ...
        <div class="flex gap-x-5 ms-1">
          ...
          <div class="grow pt-0.5 pb-8 sm:pb-12">
            <p class="text-3xl text-neutral-400">
              ...
              افتح حسابا للتداول : قم بالتسجبل مع وسيطنا الموثوق به.
            </p>
          </div>
          <!-- End Right Content -->
        </div>
        ...
        <div class="flex gap-x-5 ms-1">
          ...
          <div class="grow pt-0.5 pb-8 sm:pb-12">
            <p class="text-3xl text-neutral-400">
              ...
              إيداع الأموال: قم بتمويل حسابك بالمبلغ المفضل لديك.(يرجى ملاحظة أن الحد الأدنى للإيداع هو 1000$, لبدء التداول بنجاح مع الروبوت بطريقة فنية و فعالة)
            </p>
          </div>
          <!-- End Right Content -->
        </div>
        ...
        <div class="flex gap-x-5 ms-1">
          ...
          <div class="grow pt-0.5 pb-8 sm:pb-12">
            <p class="text-3xl text-neutral-400">
              ...
              تنشيط الروبوت على حسابك : بمجرد تمويل حسابك، قم بمراسلتنا برقم الحساب الخاص بك وفي خلال ساعات سيتم تنشيط (SMART BOT) علي حسابك.
            </p>
          </div>
          <!-- End Right Content -->
        </div>
