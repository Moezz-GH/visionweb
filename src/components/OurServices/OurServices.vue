<template>
  <div class="bg-secondarycolor h-[32rem] bg-center bg-cover bg-no-repeat pt-24">
    <div class="animate__animated animate__backInDown py-18 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
               <p class="my-4 text-5xl font-serif text-white dark:text-gray-400">نحن نفتخر بتقديم خدمات سحب و إيداع سريع   </p>
               <p class=" my-4 text-5xl font-serif text-white dark:text-gray-400">و تنافسية لتداول العملات الأجنبية من خلال وسيط</p>
               <p class=" my-4 text-5xl font-serif text-LDN dark:text-gray-400">LDNGlobalMarkets</p>
  ...
  <section class="bg-white bg-cover bg-no-repeat ">
    <div class="gap-8 items-center py-8 px-4 mx-auto max-w-screen-xl xl:gap-16 md:grid md:grid-cols-2 sm:py-16 lg:px-6">
       ...
       <div class="flex items-center justify-center">
        <img class="shadow-2xl h-[32rem] rounded-2xl hadow-lg w-2/3 dark:hidden" src="https://images.pexels.com/photos/4386433/pexels-photo-4386433.jpeg?auto=compress&cs=tinysrgb&w=600" alt="dashboard image">
       </div>
