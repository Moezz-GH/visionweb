  ...
  <section class="bg-white bg-cover bg-no-repeat ">
    <div class="gap-8 items-center py-8 px-4 mx-auto max-w-screen-xl xl:gap-16 md:grid md:grid-cols-2 sm:py-16 lg:px-6">
        <div class="mt-4 md:mt-0">
            <h2 class="mb-4 text-5xl tracking-tight font-extrabold text-secondarycolor dark:text-white">  إشحن حسابك بطريقة   </h2>
            <h2 class="mb-4 text-5xl tracking-tight font-extrabold text-secondarycolor dark:text-white">     أمنة و موثوقة  </h2>
            <hr class="my-4">
